...
FPImageList::FPImageList(wxWindow* parentWindow)
{
    //ctor
    wxSize fs = parentWindow->GetFont().GetPixelSize();
    ...
    {
        m_pImlist = new wxImageList(22, 22);
        prefix2 = ConfigManager::GetDataFolder() + _T("/images/fortranproject/22x22/");
    }
    wxBitmap bmp;
