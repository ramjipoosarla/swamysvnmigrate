...
// bitmap for use as Fortran keywords icon in code-completion list
static const char * fortran_keyword_xpm16[] = {
"16 16 2 1",
"     c None",
".    c #04049B",
"                ",
...
static const char * fortran_keyword_xpm22[] = {
"22 22 2 1",
"     c None",
".    c #04049B",
"                      ",
...
void FortranProject::BuildMenu(wxMenuBar* menuBar)
{
    ...
    if (m_FortranToolsMenu)
    {
        ...
        wxString prefix = ConfigManager::GetDataFolder() + _T("/images/fortranproject/16x16/");
...
{
    if (height <= 16)
        return wxBitmap(fortran_keyword_xpm16);

    return wxBitmap(fortran_keyword_xpm22);
}
